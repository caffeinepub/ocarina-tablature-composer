...
import type { OcarinaLayout as _OcarinaLayout, SoundPreset as _SoundPreset, SoundSettings as _SoundSettings, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllHoleLayouts(): Promise<Array<HoleLayout>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllHoleLayouts();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllPresetSongs(): Promise<Array<Song>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPresetSongs();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllSoundPresets(): Promise<Array<SoundPreset>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllSoundPresets();
    ...
    async getCurrentOctave(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getCurrentOctave();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCustomOcarinaLayout(): Promise<OcarinaLayout | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getCustomOcarinaLayout();
    ...
    async getFingeringPattern(arg0: Note): Promise<FingeringPattern> {
        if (this.processError) {
            try {
                const result = await this.actor.getFingeringPattern(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getHoleLayout(arg0: bigint): Promise<HoleLayout> {
        if (this.processError) {
            try {
                const result = await this.actor.getHoleLayout(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getNumberOfHoles(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getNumberOfHoles();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSoundPreset(arg0: string): Promise<SoundPreset> {
        if (this.processError) {
            try {
                const result = await this.actor.getSoundPreset(arg0);
                return from_candid_SoundPreset_n9(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getSoundSettings(): Promise<SoundSettings> {
        if (this.processError) {
            try {
                const result = await this.actor.getSoundSettings();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveSoundPreset(arg0: string, arg1: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveSoundPreset(arg0, to_candid_opt_n13(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setCurrentOctave(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setCurrentOctave(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateCustomOcarinaLayout(arg0: OcarinaLayout): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateCustomOcarinaLayout(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateFingeringPattern(arg0: Note, arg1: FingeringPattern): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateFingeringPattern(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateSoundSettings(arg0: SoundSettings): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateSoundSettings(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_SoundPreset_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SoundPreset): SoundPreset {
...
function from_candid_opt_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_OcarinaLayout]): OcarinaLayout | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_record_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        name: value.name,
        ocarinaImage: record_opt_to_undefined(from_candid_opt_n11(_uploadFile, _downloadFile, value.ocarinaImage))
    };
}
...
function from_candid_vec_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_SoundPreset>): Array<SoundPreset> {
    return value.map((x)=>from_candid_SoundPreset_n9(_uploadFile, _downloadFile, x));
}
